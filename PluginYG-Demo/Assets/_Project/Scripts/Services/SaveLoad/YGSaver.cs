...
namespace HomoLudens
{
    public class YGSaver : MonoBehaviour
    {
        ...
        // В данном случае, при нажатии кнопки Set Default Saves будет вызов ивента onGetSDKData
        // и мы обновим данные при сбросе сохранений
        ...
        public void GetData()
        {
            ...
            //Text.GetComponent<Text>().text = YG2.saves.CurrentLevel.ToString();
